...
export default function Work({ title, heading, subheading,textColor, role,freelance,freelance2,data,bgColor }) {
  ...
  return (
  <>  <section style={{backgroundColor:`${role ==="work" ? bgColor : ""}`}} className={`  w-full   pb-5 md:pb-10 1xl:pb-15 px-6 md:px-10 lg:px-20 1xl:px-25 2xl:px-50 3xl:px-80  overflow-hidden `}>
