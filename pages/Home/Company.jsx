...
export default function Company() {
  ...
  return (
    <section className="grid items-center justify-center w-full  text-white    py-5 md:py-10 1xl:py-15 px-6 md:px-10 lg:px-20 1xl:px-25 2xl:px-50 3xl:px-80 -mt-5  overflow-hidden">
           <div>
