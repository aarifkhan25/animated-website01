...
export default function Company() {
  ...
  return (
    <section className="grid items-center justify-center w-full  text-white  py-10 lg:py-20 1xl:py-30 px-6 md:px-10 lg:px-20 1xl:px-25 2xl:px-50 3xl:px-80 -mt-5  overflow-hidden">
           <div>
