...
const quesitons = [
  { id: "gen", label: "General Questions" },
  ...
  { id: "hire", label: "Hiring Questions" },
...
<div>
      <h2 className="text-3xl md:text-5xl lg:text-[56px] md:pl-[31%] font-mulish mt-5 md:mt-10 1xl:mt-20 py-5 lg:py-10 text-white capitalize">
        Talent FAQs
      </h2>

      {/* Main Layout Grid */}
      <div className="w-full flex flex-col gap-8 md:flex-row items-start">
        
        {/* Left Sidebar: md:top-28 kiya hai taaki sidebar khud navbar ke niche na dabe */}
        <div className="w-full md:w-[280px] lg:w-[320px] md:sticky md:top-20 flex-shrink-0 z-20">
        ...
        <div className="flex-1 w-full space-y-14">
          {quesitons.map((category) => {
            return (
              ...
              >
                {/* Category Heading */}
                <p className="text-xl md:text-3xl lg:text-[34px] font-semibold font-mulish text-white mb-3 md:mb-6">
                  {category.label}
                </p>
