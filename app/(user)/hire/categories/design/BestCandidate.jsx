...
Sorting through resumes and profiles takes hours of precious time. Pangea cuts that down to seconds by selecting the best applicants with our proprietary AI matching algorithm, so you can focus on getting to work.      </p>
   <button style={{backgroundColor:textColor}} className="group  flex justify-center items-center gap-2 transition-colors text-black py-2 px-3 lg:py-2 lg:px-4 xl:py-3 xl:px-6 rounded-full font-mulish font-bold text-sm md:text-base lg:text-xl cursor-pointer">
