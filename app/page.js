...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* start hiring */}
    <div className="md:-mt-110 lg:-mt-0">
      ...
      {/* why choose us */}
        ...
        <div className="md:-mt-220 lg:-mt-0 xl:-mt-60 1xl:-mt-80 2xl:-mt-140">
      <ChooseUs
        textColor="#9070ff"
        bgColor="#1c143d"
      ...
      {/* help for hire */}
       <div className="md:-mt-100 lg:-mt-0 xl:-mt-60 1xl:-mt-80 2xl:-mt-140">      <ChooseUs
        textColor="#ff4d00"
        bgColor="#2a1205"
      ...
      {/* work */}
       <div className="md:-mt-150 lg:-mt-0 xl:-mt-60 1xl:-mt-80 ">
      <FractionalTalent
     textColor="#fb00c6"
        bgColor="#3a002b"
        role="work"
